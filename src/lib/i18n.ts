...
export const translations = {
  en: {
    ...
    hero: {
      ...
      subtitle:
        "An AI service company building data, visual assets, educational content, and industry workflows for real-world applications.",
      explore: "Explore",
  ...
  zh: {
    ...
    hero: {
      ...
      titleLine2: "让真实生活更美好。",
      subtitle:
        "米草科技是一家人工智能服务公司，面向真实应用场景构建数据、视觉资产、教育内容与行业工作流。",
      explore: "探索业务",
      watchDemo: "观看演示",
      contact: "联系我们",
    },

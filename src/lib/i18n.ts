...
export const translations = {
  en: {
    ...
    gameAssets: {
      ...
      internalToolBullet1: "ComfyUI generation & edit pipeline running end-to-end",
      internalToolBullet2: "Custom annotation tool for difference-point labels (x, y, radius, hint, description)",
      internalToolBullet3: "Exports level-ready metadata for game configuration",
  ...
  zh: {
    ...
    gameAssets: {
      ...
      internalToolBullet1: "ComfyUI 生成与编辑管线端到端跑通",
      internalToolBullet2: "自研标注工具，记录差异点坐标、半径、提示语与描述",
      internalToolBullet3: "导出可用于关卡配置的结构化元数据",
      useCasesTitle: "使用场景",
